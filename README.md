...
Together, these components create a compact [Voice Assistant](https://www.home-assistant.io/voice_control/) and [Sendspin player](https://www.sendspin-audio.com) for ESPHome that integrates with Home Assistant.
